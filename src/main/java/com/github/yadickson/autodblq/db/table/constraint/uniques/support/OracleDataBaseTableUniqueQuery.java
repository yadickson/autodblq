 ...
 */
public class OracleDataBaseTableUniqueQuery implements DataBaseTableConstraintQuery {
    ...
    public String get(final TableBase table, final boolean keepTypes) {
        ...
        return "SELECT \n"
                ...
                + "INNER JOIN sys.all_constraints c ON cc.constraint_name = c.constraint_name AND c.constraint_type = 'U' \n"
                + "WHERE  \n"
                + filterByName(table)
